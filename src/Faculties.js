const Faculties = () => {
  ...
  const faculty = Faculties.map((x) => {
    return (
      <>
        <div class="card col-md-3">
          <img src={x.FacultyImage} class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">{x.FacultyName}</h5>
            <p class="card-text">{x.FacultyDesignation}</p>
            <p class="card-text">{x.FacultyEducationQualification}</p>
            <p class="card-text">{x.FacultyExperience}</p>
          </div>
        </div>
      </>
    );
  ...
  return <div class="row">{faculty}</div>;
};
